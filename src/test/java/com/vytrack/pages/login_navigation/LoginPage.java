...
public class LoginPage {
    ...
    @CacheLookup
    public WebElement userNameElement2;

    @FindBy(css = "[name='USER_PASSWORD']")
    @CacheLookup
    public WebElement passwordElement2;

    @FindBy(css= "[class='login-btn']")
    public WebElement loginButtonElement2;
    ...
    public void login2(String role) {
        String username = "";
        String password = "";
        if (role.equalsIgnoreCase("hp")) {
            ...
            passwordElement2.sendKeys(password);

...
public abstract class BasePage {
    ...
    protected WebElement pageSubTitle2;
    ...
    public String getPageSubTitle2() {
        //ant time we are verifying page name, or page subtitle, loader mask appears
        waitUntilLoaderScreenDisappear();
        BrowserUtils.waitForStaleElement(pageSubTitle2);
    ...
    public void navigateToModule2(String module) {
//        MoreBtn.click();
        String moduleLocator2 = "//span[@class='menu-item-link-text' and contains(text(),'" + module + "')]";
        try {
            BrowserUtils.waitForPresenceOfElement(By.xpath(moduleLocator2), Integer.valueOf(ConfigurationReader.getProperty("SHORT_WAIT")));
            BrowserUtils.waitForVisibility(By.xpath(moduleLocator2), Integer.valueOf(ConfigurationReader.getProperty("SHORT_WAIT")));
            BrowserUtils.scrollToElement(Driver.getDriver().findElement(By.xpath(moduleLocator2)));
            Driver.getDriver().findElement(By.xpath(moduleLocator2)).click();
        } catch (Exception e) {
            logger.error("Failed to click on :: " + module);
            logger.error(e);
            BrowserUtils.waitForStaleElement(Driver.getDriver().findElement(By.xpath(moduleLocator2)));
            BrowserUtils.clickWithTimeOut(Driver.getDriver().findElement(By.xpath(moduleLocator2)), Integer.valueOf(ConfigurationReader.getProperty("SHORT_WAIT")));
        }
    }
